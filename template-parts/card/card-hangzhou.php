<?php 
  ...
  <div class="card card-absolute card-hangzhou">
    ...
    <div class="card-hangzhou__media">
      <img src="<?php echo get_the_post_thumbnail_url($site, 'site-small-logo'); ?>" width="34" height="17" alt="<?php echo $siteName . ' logo'; ?>" aria-hidden="true">
    </div>

    <div class="card-hangzhou__content">
      <h3>        
    ...
    <div class="card-absolute__ctas card-hangzhou__ctas">
